...
parser.add_argument("--trained_model", default='/home/whf/Temp/11-扫地机/projects/anno_model/new_model_mos_backaug_0214/best.pt' ,type=str)

parser.add_argument("--dataset_type", default="open_images", type=str,
                    help='Specify dataset type. Currently support voc and open_images.')
parser.add_argument("--dataset", default="/home/whf/Temp/11-扫地机/projects/test_imgs",type=str, help="The root directory of the VOC dataset or Open Images dataset.")
parser.add_argument("--label_file",default='/home/whf/Temp/11-扫地机/projects/MobileNetV3-SSD/models/new_model/open-images-model-labels.txt', type=str, help="The label file path.")
...
if __name__ == '__main__':
    ...
    if args.dataset_type == "voc":
        ...
        dataset = OpenImagesDataset(args.dataset, dataset_type="test0215")
    ...
    for i in range(len(dataset)):
        ...
        # print("boxes, labels, probs:",boxes, labels, probs)
